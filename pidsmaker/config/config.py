...
DATASET_DEFAULT_CONFIG = {
    ...
    "RAS_GARONNE": {
        ...
        "unused_dates": [],
        "ground_truth_relative_path": [
            "ras_garonne/loud.csv",
            "ras_garonne/medium.csv",
            "ras_garonne/hard.csv",
            "ras_garonne/evasive.csv",
        ],
        # One attack run per synthetic date, so each window is simply its whole day.
        "attack_to_time_window": [
            ["ras_garonne/loud.csv", "2026-01-17 00:00:00", "2026-01-17 23:59:59"],
            ["ras_garonne/medium.csv", "2026-01-19 00:00:00", "2026-01-19 23:59:59"],
            ["ras_garonne/hard.csv", "2026-01-21 00:00:00", "2026-01-21 23:59:59"],
            ["ras_garonne/evasive.csv", "2026-01-23 00:00:00", "2026-01-23 23:59:59"],
        ],
    },
    ...
    "RAS_SEVERN": {
        ...
        "ground_truth_relative_path": [
            "ras_severn/loud.csv",
            "ras_severn/medium.csv",
            "ras_severn/hard.csv",
            "ras_severn/evasive.csv",
        ],
        "attack_to_time_window": [
            ["ras_severn/loud.csv", "2026-01-17 00:00:00", "2026-01-17 23:59:59"],
            ["ras_severn/medium.csv", "2026-01-19 00:00:00", "2026-01-19 23:59:59"],
            ["ras_severn/hard.csv", "2026-01-21 00:00:00", "2026-01-21 23:59:59"],
            ["ras_severn/evasive.csv", "2026-01-23 00:00:00", "2026-01-23 23:59:59"],
        ],
    },
}
